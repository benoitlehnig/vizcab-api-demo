    ...
    <v-row v-else-if="productStore.currentProduct">
      <v-col cols="12">
        <v-card>
          ...
          <v-card-subtitle>
            ID:
            {{ productStore.currentProduct.identification.po_registration_id }}
          </v-card-subtitle>
          <v-divider></v-divider>
          <v-card-text>
            <v-row>
              <v-col cols="12" md="6">
                ...
                <v-list>
                  ...
                  <v-list-item>
                    ...
                    <v-list-item-subtitle>{{
                      productStore.currentProduct.declared_unit.name
                    }}</v-list-item-subtitle>
                  </v-list-item>
                  <v-list-item>
                    <v-list-item-title>Reference Service Life (years):</v-list-item-title>
                    <v-list-item-subtitle>{{
                      productStore.currentProduct.modelling.reference_service_life
                    }}</v-list-item-subtitle>
                  </v-list-item>
                  <v-list-item>
                    <v-list-item-title>Type:</v-list-item-title>
                    <v-list-item-subtitle>{{
                      productStore.currentProduct.modelling.subtype.name
                    }}</v-list-item-subtitle>
                  </v-list-item>
                </v-list>
              </v-col>
              <v-col cols="12" md="6">
                ...
                <v-list>
                  <v-list-item
                    v-for="(impactValues, impactKey) in productStore.currentProduct.impacts
                      .details[0].impacts"
                    key="impactKey"
                  >
